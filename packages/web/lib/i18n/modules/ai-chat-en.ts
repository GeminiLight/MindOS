...
export const aiChatEn = {
  ask: {
    ...
    toolRunningProgress: (toolName: string) => `Running ${toolName}`,
    permissionWaiting: 'Waiting for your approval',
    questionWaiting: 'Waiting for your answer',
    pendingActionsTitle: 'Pending agent actions',
    pendingActionResolvedElsewhere: 'Resolved elsewhere',
    pendingActionAnswer: 'Answer',
    pendingActionCancel: 'Cancel',
    pendingActionApprove: 'Approve',
    pendingActionDeny: 'Deny',
    ...
    externalSessions: {
      ...
      "archived": "Archived",
      "hint": "Sessions on this computer. Open one to continue with its original Agent.",
  ...
  changes: {
    ...
    subtitle: 'Review agent edits first, then trace the full activity history when you need the audit trail.',
    views: {
    ...
    pathsChanged: (n: number) => `${n} file${n === 1 ? '' : 's'}`,
    unreadCount: (n: number) => `${n} unread`,
    pendingReviewCount: (n: number) => `${n} pending review`,
    allReviewed: 'All reviewed',
    scopedToPath: (path: string) => `Scoped to ${path}`,
    scopedToSpace: (space: string) => `Space: ${space}`,
    scopedToAgent: (agent: string) => `Agent: ${agent}`,
    refresh: 'Refresh',
    markSeen: 'Mark seen',
    markAllRead: 'Mark all read',
    markReviewed: 'Mark reviewed',
    expandDetails: 'Expand change details',
    collapseDetails: 'Collapse change details',
    diffLimitReached: 'This change is too large to preview. Open the file to review its contents.',
    diffPreview: 'Diff preview',
    openFile: 'Open file',
    eventListLabel: 'Content change events',
    filters: {
      facets: 'Refine',
      space: 'Space',
      filePath: 'File path',
    ...
    reviewEmpty: 'Nothing needs review.',
    reviewEmptyHint: 'Agent edits newer than your last review will appear here. Use All activity for the full timeline.',
