...
export const panelsEn = {
  ...
  agentsContent: {
    ...
    agentSubtitle: 'Manage execution endpoints such as MindOS Agent, Codex, Claude Code, and remote agents.',
...
export const panelsZh = {
  ...
  agentsContent: {
    ...
    agentSubtitle: '管理 MindOS Agent、Codex、Claude Code 与远程 Agent 等执行端点。',
