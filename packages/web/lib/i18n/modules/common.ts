...
export const commonEn = {
  ...
  login: {
    ...
    forgotIntro: 'MindOS cannot recover this local Web password.',
    forgotReset: 'On the machine running MindOS, reset it with:',
    forgotDisable: 'To temporarily remove the login gate, use:',
    forgotRestart: 'Restart MindOS after changing the setting. If this is not your machine, ask the owner to reset it.',
  },
  notFound: {
...
export const commonZh = {
  ...
  login: {
    ...
    forgotPassword: '忘记密码？',
    forgotIntro: 'MindOS 不会保存可找回的网页访问密码。',
    forgotReset: '在运行 MindOS 的那台机器上执行：',
    forgotDisable: '如果需要临时关闭登录保护，执行：',
    forgotRestart: '修改后重启 MindOS。若这不是你的机器，请联系配置这台 MindOS 的人重置。',
  },
  notFound: {
    title: '文件未找到',
