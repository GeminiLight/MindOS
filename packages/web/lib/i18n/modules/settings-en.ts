...
export const settingsEn = {
  settings: {
    ...
    plugins: {
      ...
      managerSubtitle: 'Manage built-in extensions, imported Obsidian plugins, and the surfaces where plugin capabilities appear.',
      ...
      catalogInventoryDesc: 'Browse package status like Obsidian: built-in extensions, imported plugins, disabled entries, and compatibility problems stay visible in one place.',
      ...
      marketSubtitle: 'Find Obsidian community plugins, check what MindOS can safely host, then install a local disabled copy before you enable or load anything.',
      ...
      marketResultNote: 'Market search stays read-only until you run a compatibility check. Installed packages are managed from Settings.',
      ...
      marketLocalDesc: 'Current plugin inventory from this MindOS workspace. Opening the market does not load disabled plugins.',
      marketLocalDeferred: 'Load the local inventory only when you need installed-package details.',
