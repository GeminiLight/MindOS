...
export const settingsEn = {
  settings: {
    ...
    agent: {
      ...
      contextStrategyHint: 'Auto: let the MindOS Pi runtime compact earlier messages as needed. Off: no runtime history summarization (required preflight safety pruning still applies).',
      contextStrategyAuto: 'Auto (runtime compaction)',
