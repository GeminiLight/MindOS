...
Read the assistant prompt at ${promptPath} first, then read this space's INSTRUCTION.md and inspect relevant notes in the same space. Produce one concise Markdown draft for the user to review. Do not overwrite existing canonical notes directly. If you write a file, write it under ${spaceDraftsPath(spacePath)} with a dated filename. Keep the draft focused, source-aware, and easy to accept or discard.`,
  ...
  inbox: {
    ...
    attachButton: 'Attach',
    stageNoteAction: 'Add to batch',
    editCaptureAction: 'Edit',
    editCaptureItem: (label: string) => `Edit ${label}`,
    draftSaved: 'Draft saved on this device · not yet in Inbox.',
    draftSaving: 'Saving draft on this device…',
    draftUnavailable: 'Draft is only in this window. Save to Inbox before refreshing, or retry draft saving.',
    draftConflict: 'Another window updated this draft. Your edits are only in this window; save them to Inbox before refreshing.',
    draftRetry: 'Retry draft save',
    draftScopeFailed: 'Could not confirm the current knowledge library. Your saved drafts have not been changed.',
    draftScopeChanged: 'The knowledge library changed or could not be confirmed. Reopen the original library to save this draft.',
    draftScopeRetry: 'Retry library check',
    ...
    clearComposer: 'Clear',
    captureCleared: 'Cleared. You can undo until you leave this page.',
    undoClearCapture: 'Undo clear',
    signalText: 'Text',
    signalUrl: 'URL',
    signalFile: 'File',
    densityTitle: 'Intent',
    ...
    lastSavedDesc: 'Saved in Inbox. Organize when you are ready.',
    ...
    sourcePreviewTitle: 'Source details',
    sourcePreviewIdleDesc: 'Preview the current input before saving.',
    sourcePreviewActiveDesc: 'How this source will be saved.',
    ...
    sourcePreviewSaveAs: 'Save format',
    ...
    browserBridgeOpenAction: 'Open in browser',
    browserBridgePrivateSource: 'Needs browser session',
    browserBridgeOpened: 'Opened in your browser. Sign in if needed, then click the MindOS extension to save it.',
    browserBridgeUnavailable: 'Install or enable MindOS Web Clipper to import logged-in pages.',
  ...
  view: {
    ...
    tocCollapseLabel: 'Collapse table of contents',
    tocExpand: 'Expand',
    tocExpandLabel: 'Expand table of contents',
