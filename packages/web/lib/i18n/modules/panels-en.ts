...
export const panelsEn = {
  ...
  echoPages: {
    ...
    insightTitle: 'Assistant draft',
    insightShow: 'Show draft',
    insightHide: 'Hide draft',
    insightHint:
      'Generated output appears here. Enable AI in Settings to use.',
    generateInsight: 'Generate draft',
    assistantActionHint: 'Generate a Markdown draft from this page.',
    assistantImprintTitle: 'Imprint Assistant',
    assistantThreadsTitle: 'Thread Assistant',
    assistantGrowthTitle: 'Insight Assistant',
    assistantPracticeTitle: 'Practice Assistant',
