...
// packages/mindos/src/agent/kb-extension.ts.
//
...
import { createMindosKbExtensionFromRegisteredHost } from '@geminilight/mindos/agent/kb-extension';
...
export {
  ...
  type KbMode,
} from '@geminilight/mindos/agent/kb-extension';
