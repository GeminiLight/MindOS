...
export const MINDOS_WEB_API_ROUTE_OWNERSHIP: MindosWebApiRouteOwnership[] = [
  ...
  migrated('/api/agent/pending-actions', 'high'),
  migrated('/api/agent/automation-approval', 'high'),
  migrated('/api/agent-runs', 'medium'),
  migrated('/api/agent-run-capsules', 'medium'),
  migrated('/api/agent-run-capsules/[capsuleId]/recovery', 'high'),
  ...
  migrated('/api/agent/runtime-permission', 'high'),
  ...
  migrated('/api/studio/automation-events', 'high'),
  ...
  migrated('/api/studio/automations', 'high'),
