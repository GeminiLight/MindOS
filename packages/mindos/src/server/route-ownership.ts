...
export const MINDOS_WEB_API_ROUTE_OWNERSHIP: MindosWebApiRouteOwnership[] = [
  ...
  host('/api/studio/automations', 'Studio automation scheduling stores host-local runtime state and home-directory scoped control data; Product Server should own it after automation persistence and execution are promoted.', 'high'),
