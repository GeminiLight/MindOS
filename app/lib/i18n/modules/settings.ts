...
export const settingsEn = {
  settings: {
    ...
    embedding: {
      ...
      providerApi: 'API',
      providerApiDesc: 'OpenAI, DeepSeek, Ollama, etc.',
      model: 'Model',
      ...
      apiKey: 'API Key',
      apiKeyHint: 'Leave empty for local providers (e.g., Ollama)',
...
export const settingsZh = {
  settings: {
    ...
    embedding: {
      ...
      providerApi: 'API',
      providerApiDesc: 'OpenAI、DeepSeek、Ollama 等',
      model: '模型',
